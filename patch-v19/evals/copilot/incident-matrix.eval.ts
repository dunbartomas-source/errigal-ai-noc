...
const matrix: MatrixCase[] = [
  ...
  {
    ticket: "A-2205",
    description: "Privacy-trap COMM-LOSS case loads the communication-loss procedure only after sanitized evidence and never exposes raw cross-customer identifiers.",
    expectedSkill: "communication-loss-troubleshooting",
    outputCheck: (output) => {
